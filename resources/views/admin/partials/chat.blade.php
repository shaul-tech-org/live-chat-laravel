            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="p-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shrink-0">
                    <div class="flex gap-2">
                        <input type="file" x-ref="adminFileInput" class="hidden" accept="image/jpeg,image/png,image/gif,image/webp,image/svg+xml,application/pdf,text/plain,text/csv" @change="handleFileSelect($event)">
                        <button
...
function chatTab() {
    return {
            ...
            xhr.addEventListener('load', () => {
                ...
                if (xhr.status >= 200 && xhr.status < 300) {
                    try {
                        ...
                        this.sendFileMessageAdmin(data, contentType, file.name);
                    } catch (err) {
                        console.error('[AdminChat] Upload parse error', err);
                    }
                } else {
        ...
        async sendFileMessageAdmin(uploadData, contentType, fileName) {
            if (!this.selectedRoom) return;
            ...
            try {
                ...
                console.error('[AdminChat] Send file message error', e);
            }
        },
