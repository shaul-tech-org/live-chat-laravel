<div x-data="tenantsTab()" x-cloak>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div x-show="tenants.length === 0" class="p-8 text-center">
            <svg class="w-12 h-12 mx-auto text-gray-300 dark:text-gray-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
            </svg>
            <p class="text-gray-400 dark:text-gray-500 mb-1">등록된 테넌트가 없습니다</p>
            <p class="text-xs text-gray-300 dark:text-gray-600">우측 상단의 '+ 새 테넌트' 버튼으로 추가하세요</p>
        </div>
    </div>
</div>
